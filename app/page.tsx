...
export default function Home() {
  ...
  return (
    <main>
      ...
      <footer id="contact"><div className="wrap footer-grid"><div className="footer-brand"><Image src="/images/logo.webp" alt="Vitour Xpress" width={210} height={110} /><p>The Tyre Experts. Quality tyres and professional automotive care for every road.</p></div><div><h3>Explore</h3><a href="#shop">Shop tyres</a><a href="#services">Services</a><a href="#about">About us</a></div><div><h3>Visit us</h3><p>Along your road to better driving<br />Nairobi, Kenya</p><a href="tel:+254700000000">+254 700 000 000</a><a href="mailto:hello@vitourxpress.co.ke">hello@vitourxpress.co.ke</a></div><div><h3>Workshop hours</h3><p>Mon – Sat<br /><b>8:00 AM – 6:00 PM</b></p><p>Sunday<br /><b>Closed</b></p></div></div><div className="wrap footer-bottom"><span>© 2026 Vitour Xpress. All rights reserved.</span><span>Designed for the road ahead.</span></div></footer>
    </main>
  );
}
